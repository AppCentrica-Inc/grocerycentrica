            ...
            return (
                ...
                <form className='bg-black-60 mw7 pa3 br2-ns ba b--black-10 ma0' onSubmit={this.handleSubmit.bind(this)} >
                    <fieldset className="cf bn pa0">
                        <div className="cf">
                            <input className="f6 f5-l input-reset bn fl black-80 bg-white pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns" type='text' ref='textInput' name='grocery' placeholder='Type to add new a grocery...'></input>
